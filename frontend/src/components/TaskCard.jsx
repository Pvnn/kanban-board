...
export const TaskCard = ({ task, icon, setTasks }) => {
  ...
  return (
    <>
      <div className=" rounded-lg h-30 w-71 bg-white p-4 m-3 text-sm grid grid-cols-1 text-gray-800 leading-relaxed cursor-pointer hover:scale-102 transition-all" onClick={() => setIsOpen(true)}>
